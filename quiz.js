...
function gradeAndShowResults() {
  ...
  document.getElementById('results-score-value').textContent = autoScore.toFixed(2);
  ...
  document.getElementById('breakdown-mcq-score').textContent = `${mcqCorrect}/${mcqQuestions.length} (${mcqScore.toFixed(2)} pts)`;
  document.getElementById('breakdown-tf-score').textContent = `${tfCorrect}/${tfQuestions.length} (${tfScore.toFixed(2)} pts)`;
...
function updateFinalScore() {
  ...
  document.getElementById('results-score-value').textContent = total.toFixed(2);
  ...
  document.getElementById('breakdown-short-score').textContent =
    graded === shortTotal
      ? `${shortCorrect}/${shortTotal} (${shortScore.toFixed(2)} pts)`
